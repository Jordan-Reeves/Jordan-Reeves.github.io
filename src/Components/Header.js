...
export default function Header() {
  return (
    <>
      <div id="topText" className='text-center pb-5'>
      ...
      <div className='flex flex-col md:flex-row py-8 px-5 justify-around'>
        <img src={selfImage} alt="Jordan Reeves" className='basis-1/2 self-center max-w-[200px]'/>
        <div id="aboutMe"className='basis-1/2 self-center'>
